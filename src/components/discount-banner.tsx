...
export default function DiscountBanner() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-r from-bright-purple to-brass-600 text-white py-4 px-4 text-center shadow-[0_10px_30px_rgba(168,85,247,0.3)] cursor-pointer hover:from-bright-purple/90 hover:to-brass-600/90 transition-all duration-300"
      onClick={handleClick}
    >
